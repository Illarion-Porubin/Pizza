            ...
            <Dialog open={open} onClose={handleClose}>
              ...
              <DialogContent>
                <DialogContentText sx={{ mb: 3 }}>
                  Осталось совсем немного, введите свой номер телефона, чтобы мы
                  могли подтвердить ваш заказ.
                </DialogContentText>
                <TextField
                  autoFocus
                  margin="dense"
                ...
                <DialogContentText paragraph={true} sx={{ mt: 3, mb: 0 }}>
                    ...
                    персональных данных и <Link to="#">пользовательским соглашением.</Link>
                </DialogContentText>
              </DialogContent>
              <DialogActions>
